...
export const StateContextProvider = ({ children }) => {
     const { contract } = useContract('0xE147F0590816e11Cba53de62A95F57DC133112E3');
  ...
  const getCampaigns=async()=>{
    ...
    if(searches!="")
    {
      ...
      const serchedCamapign=parsedCampaigns.filter((campaign)=>((campaign.title).toLowerCase()).includes(searches.toLowerCase()));
     

      return serchedCamapign;
    }
